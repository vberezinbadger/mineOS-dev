...
local function install_openComputers(path)
  local url = "https://raw.githubusercontent.com/vberezinbadger/mineOS-dev/main/files.list"
  ...
  local baseURL = "https://raw.githubusercontent.com/vberezinbadger/mineOS-dev/main/mineosdev/"
  for i=1, #lines, 1 do
  ...
  fs.setLabel(path, "mineOS Developer Preview")
end

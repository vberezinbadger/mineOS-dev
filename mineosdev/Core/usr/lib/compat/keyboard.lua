...
function keyboard.isAltDown()
  return keyboard.pressedCodes[0x38] or keyboard.pressedCodes[0xB8]
end

function keyboard.isControlDown()
  return keyboard.pressedCodes[0x1D] or keyboard.pressedCodes[0x9D]
end

function keyboard.isShiftDown()
  return keyboard.pressedCodes[0x2A] or keyboard.pressedCodes[0x36]
end

function keyboard.isControl(c)
...
-- The following ~140 lines are taken from OpenOS because I can't be bothered to hand-type them. --
